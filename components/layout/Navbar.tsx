...
export default function Navbar() {
  return (
    ...
    <header className="bg-white p-4">
      ...
      <nav className="container mx-auto bg-teal-800 rounded-lg px-6 py-2 flex items-center justify-between shadow-md">
        {/* Left Side: Menu + Logo */}
        ...
        <div className="hidden md:flex items-center flex-1 max-w-md mx-8 relative">
          <input
            ...
            className="w-full text-gray-800 bg-white rounded-full py-2 px-10 text-sm focus:outline-none focus:ring-1 focus:ring-slate-100"
          />
